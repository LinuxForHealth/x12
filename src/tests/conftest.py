...
@pytest.fixture
def x12_837_subscriber_drug_in_office_transaction() -> str:
    return "\n".join(
        [
...
@pytest.fixture
def x12_837_subscriber_drug_in_office_input(
    x12_control_header,
    ...
    return f"{x12_837_header}{x12_837_subscriber_drug_in_office_transaction}{x12_control_footer}"
