...
class X12BaseModel(BaseModel):
    ...
    def x12(self) -> str:
        ...
        """
        model_values = [v for v in self.dict(exclude={"delimiters", "loop_context"}).values()]
        x12_values = []
        ...
        x12_str = self.delimiters.element_separator.join(x12_values).rstrip(self.delimiters.element_separator)
