...
def test_match_no_conditions(
    mock_func_no_conditions, st_segment, data_record, parsed_st_segment
):
...
def test_match_with_conditions(
    mock_func_with_conditions, st_segment, data_record, parsed_st_segment
):
